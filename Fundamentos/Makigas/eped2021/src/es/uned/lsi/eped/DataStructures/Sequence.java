...
public abstract class Sequence<E> extends Collection<E> implements SequenceIF<E> {
	...
	/* Constructor de una secuencia vacia */
	public Sequence () {
		super();               /* Creamos una coleccion */         
		this.firstNode = null; /* La secuencia es vacia */
	}
	...
	/* Reimplementacion/Especializacion de algunos metodos de Collection */
	...
	/* Metodos heredados de CollectionIF */
